...
public class Schedules implements IDAOSchedules{
	...
	public void create(Connection connection, Schedules schedules) throws SQLException {
		...
		ps.setInt(3, schedules.getId_subject());
		ps.setInt(1, schedules.getId_alumn());
		ps.setInt(2, schedules.getId_professor());
		ps.setString(4, schedules.getStart_time());
		ps.setString(5, schedules.getEnd_time());
		ps.setString(6, schedules.getDay());
		ps.execute();
		ps.close();
	...
	@Override
	public Schedules read(Connection connection, Schedules schedules, int id_schedules) throws SQLException {
